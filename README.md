...
Hay is a simple procedural statically-typed language. It's heavily inspired by C, but aims to fix some its peculiarities that I find annoying, for example having multiple syntax options for one operation.
